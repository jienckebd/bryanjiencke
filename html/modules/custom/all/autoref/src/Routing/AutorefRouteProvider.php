...
namespace Drupal\autoref\Routing;
 ...
 */
class AutorefRouteProvider extends DefaultHtmlRouteProvider {
  ...
  public function getRoutes(EntityTypeInterface $entity_type) {
    ...
    if ($entity_type->hasLinkTemplate('add-form')) {
      $route = (new Route(($entity_type->getLinkTemplate('add-form'))))
        ->addDefaults([
          '_controller' => '\Drupal\autoref\Controller\EntityController::add',
    ...
    if ($entity_type->hasLinkTemplate('canonical')) {
      $route = (new Route($entity_type->getLinkTemplate('canonical')))
        ->addDefaults([
          '_controller' => '\Drupal\autoref\Controller\EntityViewController::view',
          '_title_callback' => '\Drupal\autoref\Controller\EntityViewController::title',
        ])
        ->setOption('_admin_route', TRUE)
