...
class AutorefManager {
   ...
   */
  public function __construct(EntityTypeManagerInterface $entity_type_manager, AutorefPluginManager $matcher_plugin_manager, ConfigFactoryInterface $config_factory, ModuleHandlerInterface $module_handler, AccountInterface $current_user, SessionManagerInterface $session_manager) {
